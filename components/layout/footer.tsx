      ...
      >
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Yash Milind Dhadge</h3>
            <p className="max-w-xs text-sm text-muted-foreground">
              Full-Stack Developer and AI/ML Enthusiast. B.Tech Computer Engineering at PCCOER, Pune. Building
              things that matter.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="/resume.pdf"
                  download="Yash_Dhadge_Resume.pdf"
                  target="_blank"
