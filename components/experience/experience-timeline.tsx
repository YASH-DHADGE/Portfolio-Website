...
import { professionalExperiences, volunteeringExperiences, type Experience } from "@/data/experience";
...
function TimelineList({ experiences }: ExperienceTimelineProps) {
    ...
    <>
        ...
        <div className="container mx-auto px-4 py-12 md:px-6 md:py-24">
          ...
          >
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              My professional journey in development and college leadership
            </p>
          </motion.div>
        </div>
      </StarHeader>
      ...
      <div className="container mx-auto px-4 pb-12 md:px-6 md:pb-24">
        <div className="mx-auto mt-12 max-w-3xl">
          <h2 className="mb-12 text-center text-2xl font-bold tracking-tight text-primary sm:text-3xl">Professional Experience</h2>
          <TimelineList experiences={professionalExperiences} />
          
          <div className="my-24" />
          
          <h2 className="mb-12 text-center text-2xl font-bold tracking-tight text-primary sm:text-3xl">College Volunteering</h2>
          <TimelineList experiences={volunteeringExperiences} />
        </div>
      </div>
    </>
  );
